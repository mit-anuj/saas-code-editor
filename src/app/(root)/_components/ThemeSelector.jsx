  ...
  return (
    <div className="relative" ref={dropDownRef}>
      <motion.button
        ...
        className="w-48 grooup relative flex items-center gap-2 px-4 py-2.5 bg-[#1e1e2e]/80 hover:bg-[#262637] rounded-lg transition-all duration-200 border-gray-800/50 hover:border-gray-700"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="px-2 mb-2 pb-2 border-b border-gray-800/50">
