...
import { ENTERPRISE_FEATURES , FEATURES } from "./_contants/index";
      ...
      <main className="relative pt-32 pb-24 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="absolute -inset-px bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl blur opacity-10"></div>
            <div className="relative bg-[#12121a]/90 backdrop-blur-xl rounded-2xl">
              ...
              <div className="absolute inset-x-0 -bottom-px bg-gradient-to-r from-transparent via-purple-500/50 to-transparent" />
